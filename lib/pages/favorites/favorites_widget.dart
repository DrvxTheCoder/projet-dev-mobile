        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<SavedRecipeRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<SavedRecipeRecord> columnSavedRecipeRecordList =
                  snapshot.data!;
              // Return an empty Container when the item does not exist.
              if (snapshot.data!.isEmpty) {
                return Container();
              }
              final columnSavedRecipeRecord =
                  columnSavedRecipeRecordList.isNotEmpty
                      ? columnSavedRecipeRecordList.first
                      : null;
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<RecipesRecord>(
                        stream: RecipesRecord.getDocument(
                            columnSavedRecipeRecord!.recipeId
                                .take(columnSavedRecipeRecord!.recipeId.length)
                                .toList()
                                .first),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          ...
                          final listViewRecipesRecord = snapshot.data!;
                          return ListView(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            listViewRecipesRecord.recipeImage,
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
