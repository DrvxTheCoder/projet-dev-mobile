...
class _AddRecipeWidgetState extends State<AddRecipeWidget>
  ...
  void initState() {
    ...
    _model.recipeDurationFocusNode ??= FocusNode();
    _model.recipeDescriptionController ??= TextEditingController();
    _model.recipeDescriptionFocusNode ??= FocusNode();
    _model.preparationController ??= TextEditingController();
    _model.preparationFocusNode ??= FocusNode();
    setupAnimations(
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              ...
                              focusNode: _model.recipeNameFocusNode,
                              autofocus: true,
                              obscureText: false,
                            ...
                            TextFormField(
                              ...
                              focusNode: _model.recipeDurationFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Durée',
                            ...
                            TextFormField(
                              ...
                              focusNode: _model.recipeDescriptionFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                            ...
                            TextFormField(
                              ...
                              focusNode: _model.preparationFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Votre nouvelle recette a été ajouté avec succès !'),
                                        actions: [
                                          TextButton(
