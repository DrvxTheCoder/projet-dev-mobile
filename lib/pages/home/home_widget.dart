    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          backgroundColor: Color(0xFF6C9E4F),
          elevation: 8.0,
          child: Icon(
            Icons.add,
            color: Colors.white,
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          ...
                          image: CachedNetworkImageProvider(
                            'https://images.unsplash.com/photo-1599354607448-8ad6e92b027a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw0fHxqb2xsb2YlMjByaWNlfGVufDB8fHx8MTY5NjkzNjEwN3ww&ixlib=rb-4.0.3&q=80&w=1080',
                          ),
                        ),
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 70.0, 0.0),
                              child: Text(
                                'Découvrez les meilleurs plats Africains',
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    'RecipeItem',
                                    queryParameters: {
                                      'recipeReference': serializeParam(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            fadeOutDuration:
                                                Duration(milliseconds: 500),
                                            imageUrl: listViewRecipesRecord
                                                .recipeImage,
                                            width: double.infinity,
                                            height: 220.0,
                                            fit: BoxFit.cover,
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            listViewRecipesRecord.recipeName
                                                .maybeHandleOverflow(
                                              maxChars: 20,
                                              replacement: '…',
                                            ),
